...
final Map<_Page1, List<_CardData>> _allPages = <_Page1, List<_CardData>>{
  new _Page1(label: 'LEFT'): <_CardData>[
    const _CardData(
  ...
  new _Page1(label: 'RIGHT'): <_CardData>[
    const _CardData(
      title: 'Beachball',
...
class TabsDemo1 extends StatelessWidget {
    ...
    return new DefaultTabController(
      ...
      child: new Scaffold(
        body: new NestedScrollView(
                ...
                child: new SliverAppBar(
                  ...
                  bottom: new TabBar(
                    tabs: _allPages.keys.map(
                          (_Page1 page) => new Tab(text: page.label),
                    ).toList(),
                  ),
                ),
              ),
          ...
          body: new TabBarView(
            children: _allPages.keys.map((_Page1 page) {
              return new SafeArea(
                top: false,
                bottom: false,
                child: new Builder(
                  builder: (BuildContext context) {
                    return new CustomScrollView(
                      key: new PageStorageKey<_Page1>(page),
                      slivers: <Widget>[
