...
final Map<_Page2, List<_CardData>> _allPages = <_Page2, List<_CardData>>{
  new _Page2(label: 'LEFT'): <_CardData>[
    const _CardData(
  ...
  new _Page2(label: 'RIGHT'): <_CardData>[
    const _CardData(
      title: 'Beachball',
...
class TabsDemo2 extends StatelessWidget {
    ...
    return new DefaultTabController(
      ...
      child: new Scaffold(
        body: new NestedScrollView(
                ...
                child: new SliverAppBar(
                  ...
                  bottom: new TabBar(
                    tabs: _allPages.keys.map(
                          (_Page2 page) => new Tab(text: page.label),
                    ).toList(),
                  ),
                ),
              ),
          ...
          body: new TabBarView(
            children: _allPages.keys.map((_Page2 page) {
              return new SafeArea(
                top: false,
                bottom: false,
                child: new Builder(
                  builder: (BuildContext context) {
                    return new CustomScrollView(
                      key: new PageStorageKey<_Page2>(page),
                      slivers: <Widget>[
